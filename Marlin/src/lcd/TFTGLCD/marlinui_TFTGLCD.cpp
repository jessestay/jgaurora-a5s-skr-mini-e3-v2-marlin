...
// Different platforms use different SPI methods
  ...
  #define SPI_SEND_ONE(V) SPI.transfer(V, SPI_TRANSMITRECEIVE);
  #define SPI_SEND_TWO(V) SPI.transfer16(V, SPI_TRANSMITRECEIVE);
...
#elif ANY(STM32F4xx, STM32F1xx)
  #define SPI_SEND_SOME(V,L,Z)  SPI.transfer(&V[Z], L, SPI_TRANSMITRECEIVE);
