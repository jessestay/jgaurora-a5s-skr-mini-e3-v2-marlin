...
// Suppress custom wiring warnings for TFTGLCD_PANEL_SPI
...
/**
 * Z-Probe configuration for future use
 * Uses Z-min endstop pin (PC_2) for both homing and probing
 * Enable when adding a Z-probe to your JGAurora A5S
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // Uncomment when adding probe
...
// Note: TOUCH_SCREEN disabled - TFTGLCD_PANEL_SPI handles touch differently
//
//#define TOUCH_SCREEN
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN               PA8 // LED driving pin (PA8 on SKR Mini E3 V2.0)
